...
public class DAOrders extends DBConnect {
    ...
    public int insertOrders(Orders ord) {
        ...
        try {
            ...
            pre.setDate(3, new java.sql.Date((new java.util.Date(ord.getOrderDate())).getTime()));
            pre.setDate(4, new java.sql.Date((new java.util.Date(ord.getRequiredDate())).getTime()));
            pre.setDate(5, new java.sql.Date((new java.util.Date(ord.getShippedDate())).getTime()));
