...
public class DAOEmployees extends DBConnect {
    ...
    public int insertEmployees(Employees em) {
        ...
        try {
            ...
            pre.setDate(5, new java.sql.Date((new java.util.Date(em.getBirthDate())).getTime()));
            pre.setDate(6, new java.sql.Date((new java.util.Date(em.getHireDate())).getTime()));
    ...
    public static void main(String[] args) {
        ...
        int n = dao.insertEmployees(new Employees(0, "fdg", "fdgfd", "fdg", "FDg", "12/02/2020", "12/03/2020", "er", "wer", "sdfsdf", "Sdf", "SDf", "Sdf", "SDf", null, "asd", 1, "dsfsf"));
        if (n > 0) {
